...
void detectObjects2()
{
    ...
    net.setPreferableBackend(cv::dnn::DNN_BACKEND_OPENCV); // DNN_BACKEND_OPENCV, DNN_BACKEND_INFERENCE_ENGINE
    net.setPreferableTarget(cv::dnn::DNN_TARGET_CPU); //DNN_TARGET_CPU, DNN_TARGET_OPENCL

    // generate 4D blob from input image
    cv::Mat blob;
    double scalefactor = 1/255.0;
    cv::Size size = cv::Size(608, 416); // 416, 608
    ...
    cout << "Avg Detection time: " << 1000 * t / 1.0 / num_runs << " ms" << endl;
